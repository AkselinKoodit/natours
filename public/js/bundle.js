        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in succesfully! Welcome!');
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            (0, _alerts.showAlert)('success', 'Bye bye!');
            window.setTimeout(function () {
              location.assign('/');
            }, 500);
            _context2.prev = 2;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2F2b25oZXJ0dHVhIiwiYSI6ImNrcnVvNnR6djE0NmUyb25wODhmYzFrY20ifQ.PMlqjcfToLie2mVS2lkaww';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/savonherttua/ckruoevqq3ja917o2jls9s5d6',
    scrollZoom: false // center: [27.6474, 62.851736],
    // zoom: 10,
    // interactive: true
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your ".concat(type, " was updated succesfully \uD83E\uDD20"));
            }
...
/* eslint-disable */
var stripe = Stripe('pk_test_51JKngFEB4GMtvmYJaZ3WrRZueiOg6lVq5W0sT2VipFO7ZqTM1oNpnDeHFoH91n07SXriXx06YZCgucdqxvt5eB0n00wZPlyCxk');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Use stripe to create checkout form+charge the credit card
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signed up succesfully! Welcome!');
              window.setTimeout(function () {
                location.assign('/');
              }, 500);
            }
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log("Let's sign up to Natours!");
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form.name, form.email, form.photo);
